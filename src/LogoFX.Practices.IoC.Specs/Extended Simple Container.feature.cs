...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "Extended Simple Container", "\tIn order to write robust flexible apps\r\n\tAs an app developer\r\n\tI want to be able" +
                    " to use inversion of control container", ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("Description", "Resolving a dependency that has been registered with a named parameter should yie" +
            "ld correct value")]
        public void ResolvingADependencyThatHasBeenRegisteredWithANamedParameterShouldYieldCorrectValue()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Resolving a dependency that has been registered with a named parameter should yie" +
                    "ld correct value", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
        ...
        [Xunit.TraitAttribute("Description", "Resolving a dependency that has been registered with a typed parameter should yie" +
            "ld correct value")]
        public void ResolvingADependencyThatHasBeenRegisteredWithATypedParameterShouldYieldCorrectValue()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
...
#line hidden
        ...
        public void ResolvingMultipleSameTypeDependenciesShouldYieldTheWholeCollection()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Resolving multiple same type dependencies should yield the whole collection", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 18
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [Xunit.TraitAttribute("Description", "Resolving a dependency that has been registered with a typed parameter in singlet" +
            "on fashion multiple times should yield same value")]
        public void ResolvingADependencyThatHasBeenRegisteredWithATypedParameterInSingletonFashionMultipleTimesShouldYieldSameValue()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Resolving a dependency that has been registered with a typed parameter in singlet" +
                    "on fashion multiple times should yield same value", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 25
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
